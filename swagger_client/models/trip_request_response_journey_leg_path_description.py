...
class TripRequestResponseJourneyLegPathDescription(object):
    ...
    def __init__(self, turn_direction=None, manoeuvre=None, name=None, coord=None, sky_direction=None, duration=None, cum_duration=None, distance=None, distance_up=None, distance_down=None, cum_distance=None, from_coords_index=None, to_coords_index=None):  # noqa: E501
